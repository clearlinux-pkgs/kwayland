...
Source0  : https://download.kde.org/stable/plasma/6.2.0/kwayland-6.2.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.2.0/kwayland-6.2.0.tar.xz.sig
...
%setup -q -n kwayland-6.2.0
cd %{_builddir}/kwayland-6.2.0
pushd ..
cp -a kwayland-6.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728620498
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKWaylandClient.so.6.2.0
/usr/lib64/libKWaylandClient.so.6
/usr/lib64/libKWaylandClient.so.6.2.0
