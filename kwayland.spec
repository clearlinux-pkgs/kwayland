...
Version  : 6.0.3
Release  : 82
URL      : https://download.kde.org/stable/plasma/6.0.3/kwayland-6.0.3.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.0.3/kwayland-6.0.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.0.3/kwayland-6.0.3.tar.xz.sig
...
%prep
%setup -q -n kwayland-6.0.3
cd %{_builddir}/kwayland-6.0.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711650092
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKWaylandClient.so.6.0.3
/usr/lib64/libKWaylandClient.so.6
/usr/lib64/libKWaylandClient.so.6.0.3
