...
Version  : 6.1.4
Release  : 91
URL      : https://download.kde.org/stable/plasma/6.1.4/kwayland-6.1.4.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.1.4/kwayland-6.1.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.4/kwayland-6.1.4.tar.xz.sig
...
%setup -q -n kwayland-6.1.4
cd %{_builddir}/kwayland-6.1.4
pushd ..
cp -a kwayland-6.1.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723139236
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKWaylandClient.so.6.1.4
/usr/lib64/libKWaylandClient.so.6
/usr/lib64/libKWaylandClient.so.6.1.4
