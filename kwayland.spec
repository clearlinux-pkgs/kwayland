...
Source0  : https://download.kde.org/stable/plasma/6.0.2/kwayland-6.0.2.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.0.2/kwayland-6.0.2.tar.xz.sig
...
%prep
%setup -q -n kwayland-6.0.2
cd %{_builddir}/kwayland-6.0.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710341586
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKWaylandClient.so.6.0.2
/usr/lib64/libKWaylandClient.so.6
/usr/lib64/libKWaylandClient.so.6.0.2
