...
Source0  : https://download.kde.org/stable/plasma/6.3.2/kwayland-6.3.2.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.2/kwayland-6.3.2.tar.xz.sig
...
%setup -q -n kwayland-6.3.2
cd %{_builddir}/kwayland-6.3.2
pushd ..
cp -a kwayland-6.3.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1740777823
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKWaylandClient.so.6.3.2
/usr/lib64/libKWaylandClient.so.6
/usr/lib64/libKWaylandClient.so.6.3.2
