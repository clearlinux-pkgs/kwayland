...
Version  : 6.3.3
Release  : 101
URL      : https://download.kde.org/stable/plasma/6.3.3/kwayland-6.3.3.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.3.3/kwayland-6.3.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.3/kwayland-6.3.3.tar.xz.sig
...
%setup -q -n kwayland-6.3.3
cd %{_builddir}/kwayland-6.3.3
pushd ..
cp -a kwayland-6.3.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742492736
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKWaylandClient.so.6.3.3
/usr/lib64/libKWaylandClient.so.6
/usr/lib64/libKWaylandClient.so.6.3.3
