...
Version  : 6.1.0
Release  : 86
URL      : https://download.kde.org/stable/plasma/6.1.0/kwayland-6.1.0.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.1.0/kwayland-6.1.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.0/kwayland-6.1.0.tar.xz.sig
...
%setup -q -n kwayland-6.1.0
cd %{_builddir}/kwayland-6.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718824349
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKWaylandClient.so.6.1.0
/usr/lib64/libKWaylandClient.so.6
/usr/lib64/libKWaylandClient.so.6.1.0
