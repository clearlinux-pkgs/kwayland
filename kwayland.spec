...
Version  : 5.110.0
Release  : 71
URL      : https://download.kde.org/stable/frameworks/5.110/kwayland-5.110.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.110/kwayland-5.110.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.110/kwayland-5.110.0.tar.xz.sig
...
%prep
%setup -q -n kwayland-5.110.0
cd %{_builddir}/kwayland-5.110.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1694453307
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF5WaylandClient.so.5.110.0
/V3/usr/lib64/libKF5WaylandServer.so.5.110.0
/usr/lib64/libKF5WaylandClient.so.5
/usr/lib64/libKF5WaylandClient.so.5.110.0
/usr/lib64/libKF5WaylandServer.so.5
/usr/lib64/libKF5WaylandServer.so.5.110.0
